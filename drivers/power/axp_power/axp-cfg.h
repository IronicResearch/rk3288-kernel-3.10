...
#define AXP_IRQNO			192//192//192//64
...
这个参数很重要，必须配置*/
#if defined(CONFIG_BOARD_TYPE_TAB8010_10d)||defined(CONFIG_BOARD_TYPE_TAB9689_9d)
	#define BATCAP				9000
#elif defined(CONFIG_BOARD_TYPE_TAB106)
	#define BATCAP	4500
#else
	#define BATCAP				8000
#endif
...
/*关屏充电电流，uA*/
#define EARCHGCUR			2100*1000
/*休眠充电电流，uA*/
#define SUSCHGCUR			2100*1000
/*关机充电电流，uA*/
#define CLSCHGCUR			2100*1000
